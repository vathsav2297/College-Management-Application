  ...
  <div class = "main-container">
    ...
    <div id="overlay">
      <div class="overlay-box more-detail-content prof-student-overlay" id="more-details-overlay">
        <h2> Dr. Elzibeth Diaz - 10019101201 </h2>
        <h3> Professor & Advisor </h3>
        <p> mxg@uta.mavs.edu </p>
        <p> Classes Taking: CSE 5301 [001]</p>
        <input class = "update-grade-input" type="text" placeholder="Assign a new Course">
        <button class = "update post" style="width: 25%;">Update</button><br>
        <button class = "update post">Send Message</button>
      </div>
    </div>
    ...
    $(document).ready(function () {
              ...
              $(document.body).on('click', '.add-row' ,function(){
                window.location.href = "../Home/addprofile.php?usertype=advisor";
              });
    });
    </script>
