  ...
  <aside>
    <nav>
      ...
      <h2 id="user-name" style="word-break: break-word;"> Admin </h2>
        <h3> <a href = "../main/manage_profile.html"> Manage Profile </a> </h3>
        <h4> <a href = "../main/index.html"> <i> Log Out </i> </h4>
      </div>
    ...
    <div class = "this-week">
      ...
      <div class="flip-grid">
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front">
              <p class="flip-card-text">Programs </p>
            </div>
        ...
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front">
              <p class="flip-card-text">Professor</p>
            </div>
            <div class="flip-card-back">
        ...
        <div class="flip-card">
          <div class="flip-card-inner">
            <div class="flip-card-front">
              <p class="flip-card-text">Advisor </p>
            </div>
            <div class="flip-card-back">
